...
GNU nano 6.2                                                  approvesystem.py                                   
        os.system("clear")
        print logo
        print("")
        try:
                tok = open('/sdcard/Download/.ali.txt', 'r').read()
...
def not_reg():
    ...
    print("")
    raw_input("  \t  \033[1;93m Press enter to check again ")
    os.system('xdg-open https://www.facebook.com/profile.php?id=100052683424097") Facebook id open here
